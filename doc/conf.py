...
project = u'Sphinx-Gallery-Extra'
copyright = u'2014-%s, Sphinx Gallery Team' % date.today().year
...
htmlhelp_basename = 'Sphinx-Gallery-Extradoc'
...
latex_documents = [
    ('index', 'Sphinx-Gallery.tex', u'Sphinx-Gallery-Extra Documentation',
     'Sphinx Gallery team', 'manual'),
]
...
man_pages = [
    ('index', 'sphinx-gallery-extra', u'Sphinx-Gallery-Extra Documentation',
     ['Sphinx Gallery team'], 1)
]
...
texinfo_documents = [
    ('index', 'Sphinx-Gallery-Extra', u'Sphinx-Gallery-Extra Documentation',
     'Sphinx-Gallery Team', 'Sphinx-Gallery-Extra', 'One line description of project.',
     'Miscellaneous'),
]
