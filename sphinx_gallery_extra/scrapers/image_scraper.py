"""Code for a scraper that detects new images that have been saved to
disk while executing a script. It will move these images to your build folder
so they can be embedded in the built documentation."""
